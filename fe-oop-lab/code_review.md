...
Такий коментар - це хороший спосіб для автора дізнатися наглядно на практиці щось нове про фреймворк, мову програмування чи архітектурні принципи. 
З часом це обовязково призведе до покращення загальної якості коду в проекті.

---

Окей, давайте перейдемо до принципів **код-ревю**.
...
Надто складний код - це такий код, який важко розібрати, просто читаючи. Це код, який при своєму використанні чи модифікації, має всі шанси завести ще декілька нових багів.
...
Однак проблеми потрібно вирішувати по мірі їх надходження, коли чітко видно їх суть і вимоги.
...
Якщо автогенерований код, дата файли чи великі структури даних можна просто просканувати очима.
ТО все, що написано живим девом, треба ретельно перечитати.
...
Тим не менше, було дуже добре внести в них елемент заохочення і вдячності автору, особливо якщо він приділив багато зусиль твоємо коментарю.
В плані навчання людині корисно вказати і на те, що вона зробила добре, а не тільки показувати помилки.
...
Дякую за увагу.
Більше цікавих штук, як наприклад як писати коменти і як хендлити заперечення можна знайти за посиланням, яке зображено на екрані.
